...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 03 mars 2025 à 18:37
...
(15, '3 - 0', '2024-10-15 12:26:33', 'victoire', 1),
(16, '3 - 0', '2024-10-15 12:26:33', 'victoire', 1),
(17, '3 - 0', '2024-10-15 12:26:33', 'victoire', 1);
...
(2, 'title', 'summary', 'description', '2024-10-18 13:36:56', NULL);
...
(6, 'John1', 'Dohn1', 'doe1@gmail.com', '$2b$10$lRYkQR6WahVT3.aIovBTFei5m95Bo1kpSWf3FEPHLA1mSb2oZoQTW'),
(7, 'Claude', 'Mlaude', 'claude@gmail.com', '$2a$10$ESX3LNw2koIvYFybBYZZPuFytsLGZyFiBjDEgXn4dZibs.NTBGUAe'),
(8, 'Claude', 'Mlaude', '1claude@gmail.com', '$2a$10$GbwWsDmfXVIbDHCniMd9IOz/8gdyLKGGfwkI0lkBX2JZ41Zv0JIq2'),
(9, 'Claude Mermoze', 'Tlaude mermoze', '11@gmail.com', '$2a$10$ZIFyhuRhLMRyw7DZW1W.CuIZpSGoyEWDh86Epe06csO6573BATE16');
...
--
ALTER TABLE `user_feature`
  MODIFY `user_feature_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
